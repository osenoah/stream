...
;;REFUELING-add those STX tokens later once it's getting close to the beginning of the stream
...
;;CALCULATING THE NUMBER OF BLOCKS A STREAM HAS BEEN ACTIVE 
...
;;CHECK BALANCE FOR PARTIES INVOLVED IN A STREAM 
...
;;REFUND, withdrawing excess tokens
